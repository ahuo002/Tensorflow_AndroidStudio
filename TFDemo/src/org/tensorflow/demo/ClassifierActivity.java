...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  public synchronized void onStart() {
    ...
    // 创建TTS对象
    mSpeech = new TextToSpeech(ClassifierActivity.this, new TTSListener());
  }
  ...
  private void text2Speech(final List<Classifier.Recognition> results) {
    ...
    if (results != null) {
      ...
      for (final Classifier.Recognition recog : results) {
        if(recog.getConfidence() > confidence) {
